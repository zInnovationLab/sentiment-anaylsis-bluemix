...
object SentimentAnalysisUtils {
  ...
  val nlpProps = {
    ...
    props.setProperty("annotators", "tokenize, ssplit, pos, lemma, parse, sentiment") // edTODO try tokenize, ssplit, parse, sentiment
    props
  }
def
   detectSentiment(message: String): SENTIMENT_TYPE = {
